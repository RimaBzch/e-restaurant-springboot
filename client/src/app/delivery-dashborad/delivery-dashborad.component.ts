...
@Component({
  selector: 'app-delivery-dashborad',
  templateUrl: './delivery-dashborad.component.html',
  styleUrls: ['./delivery-dashborad.component.css']
})
export class DeliveryDashboradComponent implements AfterViewInit , OnInit,OnDestroy{
  ...
  ngOnInit(): void {
    ...
    this.subscription =  this.OrderService.getLstOrderPayedNotAssigned().subscribe(
