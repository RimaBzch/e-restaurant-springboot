...
@Component({
  selector: 'app-delivery-assigned-me',
  templateUrl: './delivery-assigned-me.component.html',
  styleUrls: ['./delivery-assigned-me.component.css']
})
export class DeliveryAssignedMeComponent implements OnInit {
  ...
  ngOnInit(): void {
   let idCrypted= this._Activatedroute.snapshot.paramMap.get("id");
    ...
    console.log("id : ",id)
     this.subscription =  this.OrderService.getLstOrderAssignedToMe(id).subscribe(
